...
| T57 | [Sessiz tuzaklar](sessiz-tuzaklar/index.md) | Çift yapılandırma anahtarı · penceresiz idempotency | — | ✅ biri bekçiye bağlandı, diğeri şemanın zorladığı karar olarak yazıldı |
