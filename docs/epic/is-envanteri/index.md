...
| **B15** | **Ticket `status` alanları yine bayat.** B11 2026-08-20'de kapatılmıştı ve **yeniden açıldı**: `katalog-ekrani`, `change-connector`, `change-config-diff` `status: 1` görünüyor ama üçünün de kodu `main`'de birleşti (`f75bfa9`, `c193f83`, `1ae0e93`). Kapanışı bir kez yapmak yetmiyor; her birleştirmede güncellenmesi gereken bir alan. | koordinatör, her merge'de |
