...
public sealed class SimulatorMcpToolTests
{
    ...
    {
        using var services = McpTestServices.For(McpSurface.Simulator);

        var tools = BizigoMcpServer.Tools(
            McpSurface.Simulator, typeof(Bizigo.Cli.McpCommandHandlers).Assembly, services);
    ...
    public void Mutasyon_araclari_salt_okunur_ilan_etmiyor()
    {
        ...
        var tools = BizigoMcpServer
            .Tools(McpSurface.Simulator, typeof(Bizigo.Cli.McpCommandHandlers).Assembly, services)
    ...
    private sealed class SimulatorFixture : IAsyncDisposable
    {
        ...
        public static SimulatorFixture Create()
        {
            ...
            var options = BizigoMcpServer.CreateOptions(
                McpSurface.Simulator, typeof(Bizigo.Cli.McpCommandHandlers).Assembly, provider);
