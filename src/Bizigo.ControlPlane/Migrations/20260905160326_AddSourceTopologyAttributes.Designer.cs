...
namespace Bizigo.ControlPlane.Migrations
{
    ...
    [Migration("20260905160326_AddSourceTopologyAttributes")]
    partial class AddSourceTopologyAttributes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bizigo.ControlPlane.AlertRuleEntity", b =>
                {
                    ...
                    b.Property<string>("GatedFingerprint")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("gated_fingerprint");
                    ...
                    b.Property<DateTimeOffset?>("SigmaChangedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sigma_changed_at");
            ...
            modelBuilder.Entity("Bizigo.ControlPlane.RcaRunEntity", b =>
                {
                    ...
                    b.Property<bool>("CountsAgainstQuota")
                        .HasColumnType("boolean")
                        .HasColumnName("counts_against_quota");

                    b.Property<string>("DebounceKey")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("debounce_key");
                    ...
                    b.Property<string>("StateDetail")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("state_detail");

                    b.Property<string>("TriggerIdentity")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("trigger_identity");
                    ...
                    b.HasIndex("IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("ix_rca_runs_idempotency_key")
                        .HasFilter("idempotency_key IS NOT NULL");

                    b.HasIndex("ParentRunId")
                        .HasDatabaseName("ix_rca_runs_parent_run_id");

                    b.HasIndex("Rejection", "RequestedAt")
                        .HasDatabaseName("ix_rca_runs_rejection_requested_at");

                    b.HasIndex("RootRunId", "Depth")
                        .HasDatabaseName("ix_rca_runs_root_run_id_depth");

                    b.HasIndex("DebounceKey", "Accepted", "RequestedAt")
                        .HasDatabaseName("ix_rca_runs_debounce_key_accepted_requested_at");

                    b.ToTable("rca_runs", "bizigo");
                });
