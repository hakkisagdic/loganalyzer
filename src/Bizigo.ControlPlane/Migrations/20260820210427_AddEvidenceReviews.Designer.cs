...
namespace Bizigo.ControlPlane.Migrations
{
    ...
    [Migration("20260820210427_AddEvidenceReviews")]
    partial class AddEvidenceReviews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bizigo.ControlPlane.EvidenceReviewEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_evidence_reviews");

                    b.HasIndex("ReviewedAt")
                        .HasDatabaseName("ix_evidence_reviews_reviewed_at");

                    b.HasIndex("BundleId", "ReviewedAt")
                        .HasDatabaseName("ix_evidence_reviews_bundle_id_reviewed_at");

                    b.ToTable("evidence_reviews", "bizigo");
                });
